...
for i = -10:1:300%:size(E16img,3)
    ...
    if i == -10
        thandle0 = text(5,10,'\it Snap25-GCaMP6s','FontSize',5,'color','w','FontWeight','bold')
        thandle = text(240-5, 10,'E16 apex','FontSize',5,'Color','w','FontWeight','bold','HorizontalAlignment','right');
        thandle2 = text(480-5,10,'P0 apex','FontSize',5,'Color','w','FontWeight','bold','HorizontalAlignment','right');
        thandle3 = text(240-5,240+10,'E16 base','FontSize',5,'Color','w','FontWeight','bold','HorizontalAlignment','right');
        thandle4 = text(480-5,240+10,'P0 base','FontSize',5,'Color','w','FontWeight','bold','HorizontalAlignment','right');
    else
    ...
    if i > 1
        timer = text(240,465,[num2str(i) ' s'],'FontSize',5,'color','w','FontWeight','bold','HorizontalAlignment','center');
    end
